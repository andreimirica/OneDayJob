...
angular.module('oneDayJobApp')
    .controller('PostCtrl', function($scope, $http, $location, Auth) {
        ...
        this.userState = 'Arad';
        this.states = ('Arad Bacău Brăila Brașov Bucureşti Buzau Cluj-Napoca Constanța Craiova Iași Oradea Pitești Ploiești Satu-Mare Sibiu Târgu-Mureș Timișoara').split(' ').map(function(state) {
            return {
                abbrev: state
            };
        });
